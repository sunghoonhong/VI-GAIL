...
os.environ["CUDA_VISIBLE_DEVICES"]='3' # '1', '2', '3', '0,1'
...
class GAIL:
    def __init__(self, vail_sample, reward_shift, reward_aug, gae_norm, global_norm, actor_lr, critic_lr, disc_lr,
    ...
    def update(self):
        ...
        for i in range(batch_num):
            ...
            with tf.GradientTape() as tape:
                ...
                disc_loss = agent_loss + expert_loss + self.beta * kld_loss
